...
DirectEngineRef _Nullable DirectEngine_Create(
    id<MTLDevice> _Nonnull device, id<MTLCommandQueue> _Nonnull queue);

void DirectEngine_Destroy(DirectEngineRef _Nullable engine);

void DirectEngine_SetConfig(DirectEngineRef _Nonnull engine,
                            DirectEngineConfig config);

DirectEngineConfig DirectEngine_GetConfig(DirectEngineRef _Nonnull engine);

bool DirectEngine_SetTargetWindow(DirectEngineRef _Nonnull engine,
                                  CGWindowID windowID);

bool DirectEngine_SetTargetDisplay(DirectEngineRef _Nonnull engine,
                                   CGDirectDisplayID displayID);

bool DirectEngine_SetOutputDisplay(DirectEngineRef _Nonnull engine,
                                   CGDirectDisplayID displayID);
...
IOSurfaceRef _Nullable DirectEngine_GetCurrentSurface(
    DirectEngineRef _Nonnull engine);

id<MTLTexture> _Nullable DirectEngine_GetFrameTexture(
    DirectEngineRef _Nonnull engine, id<MTLDevice> _Nonnull device);

id<MTLTexture> _Nullable DirectEngine_ProcessFrame(
    DirectEngineRef _Nonnull engine, id<MTLDevice> _Nonnull device,
    id<MTLCommandBuffer> _Nonnull commandBuffer);

id<MTLTexture> _Nullable DirectEngine_GetInterpolatedFrame(
    DirectEngineRef _Nonnull engine, id<MTLDevice> _Nonnull device,
    id<MTLCommandBuffer> _Nonnull commandBuffer, bool *_Nonnull isInterpolated);

id<MTLTexture> _Nullable DirectEngine_GetInterpolatedFrameWithT(
    DirectEngineRef _Nonnull engine, id<MTLDevice> _Nonnull device,
    id<MTLCommandBuffer> _Nonnull commandBuffer, float t,
    bool *_Nonnull isInterpolated);

id<MTLTexture> _Nullable DirectEngine_InterpolateTextures(
    DirectEngineRef _Nonnull engine, id<MTLDevice> _Nonnull device,
    id<MTLCommandBuffer> _Nonnull commandBuffer,
    id<MTLTexture> _Nonnull prevTexture, id<MTLTexture> _Nonnull currTexture,
    float t);
...
id<MTLTexture> _Nullable DirectEngine_GetNextAsyncFrame(
    DirectEngineRef _Nonnull engine);

void DirectEngine_SetTargetFrameMultiplier(DirectEngineRef _Nonnull engine,
                                           int multiplier);
